(function ($) {
    ...
    $.fn.tautocomplete = function (options, callback) {
        ...
        var el = {
            ...
            ddTextbox: $("<input type='text' class='form-control'>") // modify by mh, set class='form-control'
        };
