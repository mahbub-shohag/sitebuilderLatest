...
<head>
	...
	<title>Welcome To Mahbub & Minar's Site Builder</title>
	<!-- Global stylesheets -->
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			...
			<ul class="nav navbar-nav pull-right visible-xs-block">
				<li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="fa fa-user-md"></i></a></li>
			</ul>
		</div>
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav navbar-right">
				<li>
					<a href="#">
						<i class="fa fa-desktop"></i> <span class="visible-xs-inline-block position-right"> Go to website</span>
					</a>
				</li>

				<li>
					<a href="#">
						<i class="fa fa-search"></i> <span class="visible-xs-inline-block position-right"> Contact admin</span>
					</a>
				</li>
