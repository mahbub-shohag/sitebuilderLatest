...
<html>
<head>
    <link href="<?php echo base_url();?>/assets/main_menu/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <link href="<?php echo base_url();?>/assets/main_menu/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!--//Custom Theme files -->
    <!--js-->
    <script src="<?php echo base_url();?>/assets/main_menu/js/jquery-1.11.1.min.js"></script>
</head>
<body>
<!--header-->
<div class="header">
...
<script src="<?php echo base_url();?>/assets/main_menu/js/bootstrap.js"></script>
</body>
</html>