            ...
            <table class="table table-bordered" id="view_chalan_list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"> <input type="button" id="updt_chalan" data-toggle="modal" data-target="#tx_ch_update" class="btn btn-primary updt_chalan" value="Update Chalan"/></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>CH-15893</td>
                        ...
                        <td style="text-align: center;"> <input type="button" id="updt_chalan1" data-toggle="modal" data-target="#tx_ch_update" class="btn btn-primary updt_chalan" value="Update Chalan"/></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>CH-9863</td>
                        <td style="text-align: center;">13-Dec-16</td>
                        <td style="text-align: center;">1</td>
                        <td style="text-align: right;">3,200.00</td>
                        <td style="text-align: center;"> <input type="button" class="btn btn-primary view_challan" value="View Chalan"/></td>
                    </tr>
...
<script>
    $(document).ready(function(){
        ...
        $('.view_challan').click(function(){
            window.location.href = 'create_vat_chalan';
        });
    });
</script>
<style>
