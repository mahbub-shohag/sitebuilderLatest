                  ...
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                              ...
                              <form method="post" action="<?php echo base_url(); ?>payment/do_upload_img" enctype="multipart/form-data" class="form-horizontal" id="upload_form_img">
                                  ...
                                  <input type="hidden" name="ITEM_DETAILS_ID" id="item_det_id" value="" />
                        ...
                        <div class="panel-body tab-content padding">
                            ...
                            <div id="item" class="tab-pane fade"><!-- 2nd tab div start-->
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <form class="form-horizontal"  id="my_form3" method="post" action="">
                                        <div class='col-lg-4'>
                                            <div class="form-group">
                                                <div class="col-lg-4">
...
$(document).on('change', '#item_id', function (e) {
            ...
            //Extra Work for Modal
//            $('#myModal').on('show.bs.modal', function(){
//                $('#my_form3').submit(function(e){
//                    e.preventDefault();
//                });
//                var all_item_info = $('#my_form3').serialize();
//                var chk = $('#item_id').val();
////                alert(chk);
////                exit();
//                if(chk !='') { 
//                data = all_item_info;
//                 $.ajax({
//                     url: '<?php // echo base_url();?>payment/add_bill_item_info',
//                     type:'post',
//                     data: data,
//                     success:function(data) {
//                         $('#item_det_id').val(data);
//                     }
//                 });
//                } else {
//                alert('Please Enter the details info');
//                exit();
//                }
//            });
    </script>
