...
<div class="container-fluid">
    ...
    <div class="panel-body">
        <ul class="nav nav-tabs" id="tab_menu">
            <li role="presentation" class="active"><a data-toggle="tab" href="#bill">Bill Record</a></li>
            ...
            <li role="presentation" <?php if ($bill_id == NULL) echo "class='disabled'"; ?> > <a <?php if ($bill_id != NULL) echo "data-toggle='tab' href='#item'"; ?> >Item Record</a></li>
                        ...
                        <div class="panel-body tab-content padding">
                            ...
                            <div id="item" class="tab-pane fade"><!-- 2nd tab div start-->
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div  class="col-lg-5">
                                            <span style="text-align: center; font-weight: bold;display: block">Attachment</span>
                                            <?php  file_upload_html(true); ?>
                                        </div>
                                        <div class="col-lg-4" id="item_list">
